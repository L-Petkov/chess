#ifndef INCLUDE_MAINMENU_BUTTONS_EXITGAMEBTN_H_
#define INCLUDE_MAINMENU_BUTTONS_EXITGAMEBTN_H_
...
class ExitGameBtn : public ButtonBase{
public:
...
#endif /* INCLUDE_MAINMENU_BUTTONS_EXITGAMEBTN_H_ */
